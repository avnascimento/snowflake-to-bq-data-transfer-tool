...
public class SFCDCRequestDTO extends CommonRequestDTO {
  ...
  @NotBlank(message = "Base table file format can not be blank")
  private String baseTableInBQ;

  @NotBlank(message = "Cron expression for the CDC task scheduler can not be blank")
